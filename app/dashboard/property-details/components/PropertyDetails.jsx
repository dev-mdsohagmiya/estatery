...
import plan from "@/public/dashboard/property-details/details/Plan.png";
import arrowSing from "@/public/dashboard/property-details/details/sort.png";
import LineIcon from "@/public/dashboard/property-details/icons/Line.png";
import MinimizeIcon from "@/public/dashboard/property-details/icons/maximize.png";
import ShareIcon from "@/public/dashboard/property-details/icons/share.png";
import properties from "./properties.json"
import tableData from "./totalApplications.json"
      ...
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className="grid md:grid-cols-12 mt-14 gap-5">
          ...
          <div className="md:col-span-5 mx-2 lg:mx-0">
            {/* search */}
            <div className="w-full py-3 border border-grayline rounded flex items-center gap-5 ml-3 lg:ml-0">
            ...
            {properties.map((item) => (
              <div
                key={item._id}
                className="w-full py-5 px-2 rounded-md border border-grayline hover:shadow-lg duration-500 mt-5 cursor-pointer bg-white"
              >
                <div className="md:flex gap-4 md:items-center">
                  ...
                  <div className="flex justify-between w-full pt-4 md:pt-0">
                    ...
                    <div className="flex flex-col justify-center items-center">
                      <div>
                        {item.status === "active" && (
                          <p className="text-[#6565F0] border border-grayline bg-[#E9E9F9] px-3 py-1 rounded-full text-sm font-semibold uppercase">
                            {item.status}
                          </p>
                        )}
                        {item.status === "occupied" && (
                          <p className="text-[#27AE60] border border-grayline bg-[#E6F9EE] px-3 py-1 rounded-full text-sm font-semibold uppercase">
                            {item.status}
                          </p>
                        )}
                        {item.status === "maintenance" && (
                          <p className="text-[#FF6161] border border-grayline bg-[#F9E9E9] px-3 py-1 rounded-full text-sm font-semibold uppercase">
                            {item.status}
                          </p>
                        )}
                        {item.status === "request" && (
                          <p className="text-[#FFB154] border border-grayline bg-[#FFF1E0] px-3 py-1 rounded-full text-sm font-semibold uppercase">
                            {item.status}
                          </p>
                        )}
                        {item.status === "vacant" && (
          ...
          <div className="md:col-span-7">
            ...
            <div>
              ...
              <div className="px-2 md:px-0 py-4 relative">
                ...
                <div className="flex gap-2 absolute top-8 right-8">
                  <div className="border border-grayline p-1 rounded-md">
            ...
            {/* details */}
            <div className="grid grid-cols-3 md:grid-cols-6 gap-5 px-5 border border-grayline rounded-md items-center w-full py-2 text-center lg:text-start bg-white">
              <div>
            ...
            {/* total application */}
            <div className="border border-grayline p-4 mt-10 bg-white rounded-sm">
        ...
        text-[#000929] "
              ...
              <div className="mt-5 grid">
                <div className="">
                  <div className="text-[12px] md:text-[16px] text-[#7F8287] font-medium border-b-2 border-grayline pb-5">
                  ...
                  <div className="text-[#000929] text-[12px] md:text-[16px] font-medium ">
                    {tableData?.map((item) => (
                      <div
                        key={item._id}
                        className="grid grid-cols-12 py-5 border-b border-grayline"
                      >
